...
$string['username_help'] = 'This sets the username of the Redis server.';
...
$string['test_username'] = 'Test server username';
$string['test_username_desc'] = 'Redis test server username.';
$string['test_password'] = 'Test server password';
$string['test_password_desc'] = 'Redis test server password.';
$string['test_prefix'] = 'Test key prefix';
$string['test_prefix_desc'] = 'Redis test key prefix';
